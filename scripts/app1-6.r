{
  ...
  cat("The temperature measurements are from",location);
  cat("\nHigh temps from the last 5 days", temp1, temp2, temp3, temp4,temp5);
  cat("\nThe average temperature was", averageTemp);
}